echo "# previous-adimaropik-bangsat" >> README.md
git init
git add README.md
git commit -m "first commit"
git remote add origin https://github.com/habibiemw3/previous-adimaropik-bangsat.git
...
#           toolsm.ropikv1.9
#
#              toolsm.ropik Create By:hmw3
#              youtube:https://www.youtube.com/c/habibiemw3
#              github:https://github.com/hmw3
#              roxy:star@xxstar
#
#
#
...
echo ""
echo -e $cyan"    Create by           $white":" $red Hmw3  "
echo -e $cyan"    Youtube Channel     $white":" $red https://www.youtube.com/c/Habibiemw3"
echo -e $cyan"    Github              $white":" $red https://github.com/hmw3"
echo -e $cyan"    Jabber              $white":" $red star@xxstar"
echo -e $cyan ""
	...
	echo "[9] ✔ PwGen"
        ...
        case "$option" in 
            1)  echo "Gmail-Hack"
                ...
                sleep 2
                git clone https://github.com/hmw3/gmailhack > /dev/null 2>&1
                echo
            ...
            2)  echo "InstaBrute"
                ...
                sleep 2
                git clone https://github.com/hmw3/instabrute > /dev/null 2>&1
                echo
            ...
            3)  echo "PYcrypt"
                echo -e $red "############## PYcrypt ###################"
                sleep 2
                git clone https://github.com/hmw3/PYcrypt > /dev/null 2>&1
                echo
            ...
            4)  echo "FBI"
                echo -e $red "############## FBI ###################"
                sleep 2
                git clone https://github.com/hmw3/fbi > /dev/null 2>&1
                echo
            ...
            5)  echo "FindUser"
                echo -e $red "############## FindUser ###################"
                sleep 2
                git clone https://github.com/hmw3/finduser > /dev/null 2>&1
                echo
            ...
            6)  echo "1337-Translator"
                ...
                sleep 2
                git clone https://github.com/hmw3/1337-translator > /dev/null 2>&1
                echo
            ...
            7)  echo "VenomGen"
                echo -e $red "############## VenomGen ###################"
                sleep 2
                git clone https://github.com/hmw3/VenomGen > /dev/null 2>&1
                echo
	    ...
	    9)  echo "PwGen"
                echo -e $red "############## PwGen ###################"
                sleep 2
                git clone https://github.com/hmw3/PwGen > /dev/null 2>&1
                echo
                ...
                clear
                ;;
            q)  echo -e $yellow " Thanks For Using My Tools Good Bye  {Hmw3}  !!"
                echo
                exit 0 
                ;;
        esac
